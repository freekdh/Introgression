...
We look at \textcolor{red}{\textbf{genetic rescue}} conditioned on evolutionary rescue.

\end{frame}

\begin{frame}{Genetic rescue}
    What is \textcolor{red}{genetic rescue}? Some explanation what we understand by genetic rescue. 
\end{frame}

\begin{frame}{The 2 locus model: JMS}
...
We assume a wildtype population of $aB$ haplotypes and a few introduced $Ab$ rescue haplotypes. Genetic rescue is defined as the proportion of $B$ alleles linked to $A$ as $t\to\infty$.
\begin{equation*}
    \frac{AB_n}{AB_n+Ab_n} = \frac{p_nQ_n}{p_nQ_n+p_n(1-Q_n)} = \color{red} Q_n
\end{equation*}
...
\begin{frame}{Results}
    \includegraphics[width=1.0\textwidth]{M}
\end{frame}

\begin{frame}{The infinite loci model - Recursion equations}
