...
\begin{overpic}[width=0.9\textwidth]{Figures/NumericalSolution.eps}
\large
 \put (50,50) {$F_b[t] = \sum_{i=1}^t 2^{-i} (1-p_b[i])$}
\normalsize
\end{overpic}
\end{frame}
...
\begin{frame}{Infinite loci model}
